            ...
            <table class="w-full border-t">
                ...
                <tbody class="">
                  <tr v-for="factura in facturas" :key="factura.idregistro"  class="">
                    ...
                    <td v-if="factura.dias_vencida >= 0" class="w-16 px-4 py-1 text-xs text-right border">{{ factura.dias_vencida   }}</td>
                    <td v-else class="w-16 px-4 py-1 text-xs text-right border"></td>
                    <td class="w-24 px-4 py-1 text-xs text-right border">{{ factura.valor_cartera  }}</td>
                  </tr>
                </tbody>
              </table>
              <div class="">
